...
### Added
- Created project-specific CHANGELOG.md (located in `docs/reference/`)
...
- Moved CHANGELOG.md from root to `docs/reference/` for better organization
- Removed convenience wrapper scripts from root (all scripts now in `scripts/` folder)
